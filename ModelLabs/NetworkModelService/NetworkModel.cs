...
{	
	// Klasa koja manipulise kontejnerima (svim tipovima entiteta)
		...
		private void InsertEntity(ResourceDescription rd)
		{
			...
			try
			{
				...
				else
				{
					...
					// Dodajemo u mapu svih kontejnera
				...
				// Dobili smo instancu novog objekta, ali atributi su i dalje na defaultnim vrednostima
				...
				if (rd.Properties != null)
				{
					...
					{						
						...
						{
							// Iz importera ne stize gotov gid
							continue;
						}
						...
						if (property.Type == PropertyType.Reference)
						{
							...
							long targetGlobalId = property.AsReference();	// izvuci vrednost propertija
							// dobijamo gid onoga sto se referencira
