...
{	
	// Jedna od najvaznijih klasa - sva logika za baratanje model kodovima
	...
	public class ModelResourcesDesc
	{
		...
		private void InitializeTypeIdsInInsertOrder()
		{
			...
			// Obratiti paznju na redosled zbog referenci
			// Redosled obradjivanja klasa od strane adaptera
			typeIdsInInsertOrder.Add(ModelCode.EQCONTAINER);
		...
		// Atributi koji ne mogu spolja da dodju na servis
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.CONNODECONTAINER_CONNODES);
