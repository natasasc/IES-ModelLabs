...
{
	// Opisuje povezanost klasa
	[DataContract]
	public class Association
	{
		private bool inverse;			// mi uvek koristimo false (po default-u)
		private ModelCode propertyId;	// opisuje kako od source-a da dobijemo rezultate
		private ModelCode type;			// mozemo dodatno da filtriramo rezultate po ovom tipu
